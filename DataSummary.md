...
This page acts as a legend for NeuroVenture data. It tells you how and where to find the data you're searching for, including what each instrument is, how its variables are named, and where to find it in the data files.
...
3. Look up that variable name in the data dictionary indicated by the legend (coventure_data_dictionary.csv or data_dictionary.csv) → `variable_name` column
...
**Substance use:** [DEP-ADO](#depapo_--dep-ado-substance-use-screening) · [DMQ](#dmq_--drinking-motives-questionnaire) · [CMQ](#cmq_--cannabis-motives-questionnaire) · [Social Norms](#soc_norms_--perceived-social-norms) · [SURPS](#surps_--substance-use-risk-profile-scale)
...
**Demographics & sessions:** [DEM](#dem_--demographics)

**Cognitive tasks:** [CMS](#cms--memory-task) · [SWM](#swm--spatial-working-memory) · [CFT](#cft--culture-fair-non-verbal-iq-test) · [PALP](#palp--probabilistic-associative-learning-paradigm)

**Cognitive/clinical battery:** BART · Stop-Signal Task · n-back · DAWBA · CTQ · Timeline Follow-Back · WISC · Stroop
**Cognitive/behavioural tasks (eprime):** [BART](#bart-balloon-analogue-risk-task--risk-taking-task) · [Stop-Signal Task](#stop-signal-task--response-inhibition-task) · [n-back task](#n-back-task--working-memory-task)

**Cognitive/clinical assessments (pen & paper / psytools):** [SURPS](#surps--substance-use-risk-profile-scale-neuroventure) · [Behavioural Scores](#behavioural_scores--memory-iq-and-executive-function-battery)

**Clinical diagnostic interview:** [DAWBA](#dawba--development-and-well-being-assessment)

**Trauma history:** [CTQ_X](#ctq_x--childhood-trauma-questionnaire)

**Substance use:** [Timeline Follow-Back](#time_line_follow_back--timeline-follow-back-substance-use-calendar)

**Demographics & session administration:** [Demographic Information](#demographic_informations--participant-demographics--history)·[Testing Sessions](#testing_sessions--session-level-metadata)·[Codes](#codes--administrative-id-codes)
**---
...
- **Timepoints:** Y1–Y5 · **Where:** columns 75–2451 (165 columns)
...
- **Description:** Personality risk-factor scale for substance misuse, 4 subscales: Negative Thinking (NT), Anxiety Sensitivity (AS), Impulsivity (IMP), Sensation Seeking (SS). Raw and z-scored versions exist (school-relative and sample-relative).
- **Timepoints:** Y1–Y5 
- **Dictionary:** `coventure_data_dictionary.csv`, ‘data_dictionary.csv’ (neuroventure data dictionary) `instrument == "SURPS_"`
- **Example variable:** `ZSURPS_NT_School_Y#` = NT subscale, z-scored vs. school mean; `ZSURPS_NT_Total_Y#` = z-scored vs. full sample.
- **notes:** `SURPS_SS_Raw` = raw Sensation Seeking score; `SS_HighestZ` / `IMP_HighestZ` = flags classifying a participant as Sensation-Seeking or Impulsive risk group, based on whichever z-score is highest; `Group` = participant's assigned risk group
...
- **Description:** A bundle of pen-and-paper/psytools cognitive test scores
...
## Demographics & session administration
...
### `TESTING_SESSIONS` — testing session information
